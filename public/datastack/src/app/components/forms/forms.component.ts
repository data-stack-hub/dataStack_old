...
ngOnChanges(change:any){
    if (!change.state.firstChange){
      this.props.state = change.state.currentValue
    }
  }
  ngOnInit() {
    console.log(this.props.controls)
    console.log(this.props.events)
    this.createForm(this.props.controls)
    this.appinit.get_query_params().subscribe((queryParams:any)=>{
      // console.log(res)
      this.props.edit = queryParams.edit
      console.log('loading for form with edit = ', this.props.edit)
      if (queryParams.edit){
        this.get_data()
      }
    })
  ...
  get_data(){
    console.log('api', this.props.data_load_url)
    this.appinit.dispatch_event({type:'http', params:{url:this.props.data_load_url} }).subscribe(res=>{
      console.log(res)
  ...
  onSubmit() {
    ...
    this.appinit.dispatch_event(event).subscribe(res=>{
      ...
      this.appinit.dispatch_event(this.props.events.submit.error)
    })
  }
